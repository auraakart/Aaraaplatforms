	...
	*/
	public static function onlySendOTPSMS( $phone_code, $phone_no ){
		...
		if( xoo_ml_helper()->sms_enabled && xoo_ml_helper()->get_phone_option('m-operator') !== 'firebase' ){
			...
			// Record the OTP SMS attempt (result included) so it appears in the
			// Aaraa notification SMS log alongside order/wallet messages.
			do_action( 'xoo_ml_otp_sms_sent', $smsParams, $smsSent );
