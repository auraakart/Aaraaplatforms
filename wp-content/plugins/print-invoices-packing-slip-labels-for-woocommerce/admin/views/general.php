			...
			<tbody>
				<?php
					...
					$settings_arr['general_address_details'] = array(
						...
						'woocommerce_wf_packinglist_sender_email' => array(
							'type'   => 'wt_text',
							'label'  => __( 'Email', 'print-invoices-packing-slip-labels-for-woocommerce' ),
							'name'   => 'woocommerce_wf_packinglist_sender_email',
							'class'  => 'woocommerce_wf_packinglist_sender_email',
							'ref_id' => 'woocommerce_wf_packinglist_sender_email',
						),
