...
<tr>
	<td style="padding:0;">
		<div>
			...
			?>
			,</p>
			<p style="margin: 0 0 16px;"><?php echo esc_html__( 'We would like to notify you that amount ', 'wallet-system-for-woocommerce-pro' ); ?><span style="color: green;"><?php echo wp_kses_post( $credit_amount ); ?></span> <?php echo esc_html__( ' has been credited successfully from your wallet through Cashback.', 'wallet-system-for-woocommerce-pro' ); ?></p>
		...
		<div>
			...
			<tbody>
					...
					<tr>
						<th style="border: 1px solid #e5e5e5; border-collapse: collapse; width: 300px"><?php echo esc_html__( 'Credit Cashback Amount', 'wallet-system-for-woocommerce-pro' ); ?></th>
