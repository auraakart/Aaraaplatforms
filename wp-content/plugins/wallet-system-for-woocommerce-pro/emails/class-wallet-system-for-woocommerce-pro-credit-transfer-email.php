...
if ( ! class_exists( 'Wallet_System_For_Woocommerce_Pro_Credit_Transfer_Email' ) ) {
	 ...
	 * @subpackage Subscriptions_For_Woocommerce/email
	 */
	class Wallet_System_For_Woocommerce_Pro_Credit_Transfer_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->id          = 'wps_wswp_wallet_credit_transfer';
			$this->title       = __( 'Wallet transfer credited Email Notification', 'wallet-system-for-woocommerce-pro' );
			$this->customer_email = true;
			$this->description = __( 'This Email Notification Send if any user wallet is credited', 'wallet-system-for-woocommerce-pro' );

			$this->template_html  = 'wps-wswp-credit-transfer-email-template.php';
			$this->template_plain = '';
		...
		public function get_default_heading() {
			return __( 'Wallet Transfer Credited', 'wallet-system-for-woocommerce-pro' );
		}
		 ...
		 * @param string $text is the text of mail.
		 * @return void
		 */
		public function trigger( $user_id, $user_name, $credit_amount, $text = '' ) {
			$attachment = '';
...
return new Wallet_System_For_Woocommerce_Pro_Credit_Transfer_Email();
