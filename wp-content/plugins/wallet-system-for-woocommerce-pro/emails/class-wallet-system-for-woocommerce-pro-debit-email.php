...
if ( ! class_exists( 'Wallet_System_For_Woocommerce_Pro_Debit_Email' ) ) {
	 ...
	 * @subpackage Subscriptions_For_Woocommerce/email
	 */
	class Wallet_System_For_Woocommerce_Pro_Debit_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->id          = 'wps_wswp_wallet_debit';
			$this->title       = __( 'Wallet Debited Email Notification', 'wallet-system-for-woocommerce-pro' );
			$this->customer_email = true;
			$this->description = __( 'This Email Notification Send if any user wallet is debited', 'wallet-system-for-woocommerce-pro' );

			$this->template_html  = 'wps-wswp-debit-email-template.php';
			$this->template_plain = '';
		...
		public function get_default_subject() {
			return __( 'Wallet Debited Email {site_title}', 'wallet-system-for-woocommerce-pro' );
		}
		...
		public function get_default_heading() {
			return __( 'Wallet Debited', 'wallet-system-for-woocommerce-pro' );
		}
		 ...
		 * @param [type] $debit_amount amount debited.
		 * @param string $order_id is the order id.
		 * @return void
		 */
		public function trigger( $user_id, $user_name, $debit_amount, $order_id = '' ) {
			$attachment = '';
...
return new Wallet_System_For_Woocommerce_Pro_Debit_Email();
