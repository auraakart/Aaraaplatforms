			...
			if ( ! empty( $wps_wallet_recharge_tab_array ) && is_array( $wps_wallet_recharge_tab_array ) ) {
				...
				if ( $count_data > 0 ) {
					...
					for ( $i = 0; $i < $count_data; $i++ ) {
						...
						<tr>
									...
									<label class="mdc-text-field mdc-text-field--outlined">
										<span class="mdc-notched-outline">
											<span class="mdc-notched-outline__leading"></span>
												...
												placeholder="<?php echo esc_attr__( ' Enter Recharge Amount ', 'wallet-system-for-woocommerce-pro' ); ?>"
												min=0
												>
											</label><br>
							...
							if ( 0 == $index ) {
								?>
									<input type="button" id="wps_wallet_bookie" value="<?php esc_html_e( 'Add', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
								<?php

							} else {
								?>
									<input type="button" onclick="remove_tr_row(this)" class="wps_wallet_action_recharge_tab_remove" value="<?php esc_html_e( 'Remove', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
								<?php
							}
							?>
				...
				?>
					<tr>
						...
						<div class="wps-form-group__control-wps">
							<label class="mdc-text-field mdc-text-field--outlined">
								<span class="mdc-notched-outline">
									...
									<span class="mdc-notched-outline__notch">
										<!-- dynamic inline style will be added -->
										<span class="mdc-floating-label" id="my-label-id" style=""><?php echo esc_attr__( ' Enter Wallet Amount ', 'wallet-system-for-woocommerce-pro' ); ?></span>	
									</span>
									<span class="mdc-notched-outline__trailing"></span>
								</span>
								<input
						...
						<td><input type="button" id="wps_wallet_bookie" value="<?php esc_html_e( 'Add', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
					</tr>
				<?php
			}
			?>
