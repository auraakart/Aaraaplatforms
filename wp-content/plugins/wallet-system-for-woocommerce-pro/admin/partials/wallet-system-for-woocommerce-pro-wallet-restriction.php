...
<form action="" method="POST" class="wps-wsfw-gen-section-form">
	...
	<div class="wsfw-secion-wallet-restrictions">
		...
		<?php
			...
			$wsfw_wallet_action_html = $wsfwp_wps_wsfwp_obj->wps_wsfwp_plug_generate_html( $wsfw_wallet_withdrawal_transfer_settings );
		...
		<?php
			...
			$wsfw_wallet_action_html = $wsfwp_wps_wsfwp_obj->wps_wsfwp_plug_generate_html( $wsfw_wallet_withdrawal_restriction_settings );
		if ( ! empty( $wsfw_wallet_action_html ) ) {
			echo wp_kses_post( $wsfw_wallet_action_html );
		}
		?>
