			...
			if ( ! empty( $wps_wallet_bookie_array ) && is_array( $wps_wallet_bookie_array ) ) {
				...
				if ( $count_data > 0 ) {
					...
					for ( $i = 0; $i < $count_data; $i++ ) {
						...
						<tr>
							<td>
								<div class="wps-form-group__control">
									<label class="mdc-text-field mdc-text-field--outlined">
										...
										placeholder="<?php echo esc_attr__( ' Enter Promotion Title ', 'wallet-system-for-woocommerce-pro' ); ?>"
										>
									</label><br>
								...
								<div class="wps-form-group__control">
									...
									<label class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea mdc-text-field--no-label">
										...
										<span class="mdc-text-field__resizer">
											...
											name="wallet_promotions_data_content[]" id="wallet_promotions_data_content[]" placeholder="<?php echo esc_attr__( ' Enter Promotion Data ', 'wallet-system-for-woocommerce-pro' ); ?>"
							...
							if ( 0 == $index ) {
								?>
									<input type="button" id="wps_wallet_promotions_button" value="<?php esc_html_e( 'Add', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
								<?php

							} else {
								?>
									<input type="button" onclick="remove_tr_row(this)" class="wps_wallet_bookie_remove" value="<?php esc_html_e( 'Remove', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
								<?php
				...
				?>
						<tr>
							...
							<td><input type="button" id="wps_wallet_promotions_button" value="<?php esc_html_e( 'Add', 'wallet-system-for-woocommerce-pro' ); ?>"></td>
						</tr>
					<?php
			}
			?>
