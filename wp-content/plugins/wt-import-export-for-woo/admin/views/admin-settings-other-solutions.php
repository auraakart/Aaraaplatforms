...
$plugins=array(    
    ...
    'diplay_discount' => array(
        'title'         => __('Display Discounts for WooCommerce', 'wt-import-export-for-woo'),
        'description'   => __('Display the WooCommerce coupon deals available for each product on the respective product pages. Make use of multiple coupon layouts & display options to fully optimize the look & feel of the coupons.', 'wt-import-export-for-woo'),
    ...
    'best_sellers_plugin' => array(
        'title'         => __('WebToffee WooCommerce Best Sellers', 'wt-import-export-for-woo'),
        'description'   => __('Highlight top-selling products on your WooCommerce store using best seller labels, sliders, and custom seals. You can display ranking positions for best-seller products in different categories.', 'wt-import-export-for-woo'),
