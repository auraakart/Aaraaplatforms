	...
	public function load_scripts($end_point) {
		...
		switch ($end_point) {
			...
			case 'wcfm-affiliate':
				...
				$wcfm_datatable_column_defs = '[{ "targets": 0, "orderable" : false }, { "targets": 1, "orderable" : false }, { "targets": 2, "orderable" : false }, { "targets": 3, "orderable" : false }, { "targets": 4, "orderable" : false },{ "targets": 5, "orderable" : false }]';
																	
				$wcfm_datatable_column_defs = apply_filters( 'wcfm_datatable_column_defs', $wcfm_datatable_column_defs, 'affiliate-stats' );
				
				// Affiliate stats Columns Priority
				$wcfm_datatable_column_priority = '[{ "responsivePriority": 1 },{ "responsivePriority": 2 },{ "responsivePriority": 3 },{ "responsivePriority": 4 },{ "responsivePriority": 5 },{ "responsivePriority": 1 }]';
				$wcfm_datatable_column_priority = apply_filters( 'wcfm_datatable_column_priority', $wcfm_datatable_column_priority, 'affiliate-stats' );
				
				wp_localize_script( 'dataTables_js', 'wcfm_datatable_columns', array( 'defs' => $wcfm_datatable_column_defs, 'priority' => $wcfm_datatable_column_priority, 'bFilter' => apply_filters( 'wcfm_datatable_bfiltery', ( wcfm_is_vendor() ) ? true : true, 'affiliate-stats' ) ) );
			...
			case 'wcfm-affiliate-stats':
				...
				// Affiliate stats Columns Priority
				$wcfm_datatable_column_priority = '[{ "responsivePriority": 1 },{ "responsivePriority": 3 },{ "responsivePriority": 1 },{ "responsivePriority": 2 },{ "responsivePriority": 4 },{ "responsivePriority": 1 }]';
				$wcfm_datatable_column_priority = apply_filters( 'wcfm_datatable_column_priority', $wcfm_datatable_column_priority, 'affiliate-stats' );
