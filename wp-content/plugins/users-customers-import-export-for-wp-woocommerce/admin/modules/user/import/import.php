...
class Wt_Import_Export_For_Woo_User_Basic_User_Import {
    ...
    public function prepare_data_to_import($import_data,$form_data, $batch_offset, $is_last_batch){
        ...
        // Suppress AaraaNotifications wallet SMS/WhatsApp while importing balances.
        add_filter('aaraa_notify_suppress', '__return_true');
        ...
        remove_filter('aaraa_notify_suppress', '__return_true');
