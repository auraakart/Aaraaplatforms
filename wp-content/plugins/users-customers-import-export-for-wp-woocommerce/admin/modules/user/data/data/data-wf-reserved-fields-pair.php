...
if ( class_exists( 'WooCommerce' ) ):
    ...
    $columns['wps_wallet'] = array('title'=>'Wallet balance (wps_wallet)','description'=>'WP Swings wallet balance');
    $columns['aaraa_delivery_slot'] = array('title'=>'Delivery slot (aaraa_delivery_slot)','description'=>'Aaraa delivery slot');
    $columns['aaraa_delivery_hub'] = array('title'=>'Delivery hub (aaraa_delivery_hub)','description'=>'Aaraa delivery hub');
    $columns['aaraa_delivery_boy'] = array('title'=>'Delivery boy (aaraa_delivery_boy)','description'=>'Aaraa delivery boy');
    $columns['xoo_ml_phone_code'] = array('title'=>'Phone country code (xoo_ml_phone_code)','description'=>'Mobile Login for WooCommerce phone country code');
    $columns['xoo_ml_phone_no'] = array('title'=>'Phone number (xoo_ml_phone_no)','description'=>'Mobile Login for WooCommerce phone number');
    $columns['xoo_ml_phone_display'] = array('title'=>'Phone display (xoo_ml_phone_display)','description'=>'Mobile Login for WooCommerce full display number');
endif;
