...
if ( class_exists( 'WooCommerce' ) ):
    ...
    // WP Swings "Wallet System for WooCommerce" balance (user meta wps_wallet).
    $columns['wps_wallet'] = 'wps_wallet';

    // Aaraa delivery assignment (user meta).
    $columns['aaraa_delivery_slot'] = 'aaraa_delivery_slot';
    $columns['aaraa_delivery_hub'] = 'aaraa_delivery_hub';
    $columns['aaraa_delivery_boy'] = 'aaraa_delivery_boy';

    // Mobile Login for WooCommerce (Xoo) phone (user meta).
    $columns['xoo_ml_phone_code'] = 'xoo_ml_phone_code';
    $columns['xoo_ml_phone_no'] = 'xoo_ml_phone_no';
    $columns['xoo_ml_phone_display'] = 'xoo_ml_phone_display';
