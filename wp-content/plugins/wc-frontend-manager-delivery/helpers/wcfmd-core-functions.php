...
if (!function_exists('wcfm_update_order_delivery_boys_meta')) {
	function wcfm_update_order_delivery_boys_meta($order_id, $delivery_boys_array = array()) {
		...
		if (!empty($delivery_boys_array)) {
			...
			$order->update_meta_data( '_wcfm_delivery_boys', $delivery_boys_string);
			$order->save();
		}
	}
}
...
if ( ! function_exists( 'get_wcfmd_delivery_hubs_url' ) ) {
	function get_wcfmd_delivery_hubs_url() {
		$wcfm_page = get_wcfm_page();
		return apply_filters( 'wcfmd_delivery_hubs_url', wcfm_get_endpoint_url( 'wcfm-delivery-hubs', '', $wcfm_page ) );
	}
}
...
if (!function_exists('get_wcfm_deliveries_pdf_url')) {
	function get_wcfm_deliveries_pdf_url() {
		$wcfm_page = get_wcfm_page();
		return apply_filters( 'wcfmd_deliveries_pdf_url', wcfm_get_endpoint_url('wcfm-deliveries-pdf', '', $wcfm_page) );
	}
}
...
if (!function_exists('get_wcfm_start_from_delivery_times')) {
	function get_wcfm_start_from_delivery_times() {
		...
		$start_from_delivery_times = apply_filters(
			'wcfm_start_from_delivery_time_options',
			array(
				0 => __('10 minutes', 'wc-frontend-manager-delivery'),
...
if (!function_exists('get_wcfm_end_at_delivery_times')) {
	function get_wcfm_end_at_delivery_times() {
		return apply_filters(
			'wcfm_end_at_delivery_time_options',
			array(
...
if (!function_exists('get_wcfm_slots_duration_delivery_times')) {
	function get_wcfm_slots_duration_delivery_times() {
		return apply_filters(
			'wcfm_slots_duration_delivery_time_options',
			array(
