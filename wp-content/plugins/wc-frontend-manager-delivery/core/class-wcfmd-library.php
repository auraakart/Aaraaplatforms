  ...
  public function load_scripts( $end_point ) {
	  ...
	  switch( $end_point ) {
	    ...
	    case 'wcfm-delivery-boys':
	    	...
	    	wp_enqueue_script( 'wcfmd_delivery_boys_js', $this->js_lib_url . 'wcfmd-script-delivery-boys.js', array('jquery', 'dataTables_js'), $WCFMd->version . '.1', true );
      ...
      case 'wcfm-delivery-boys-stats':
	    	...
	    	wp_enqueue_script( 'wcfmd-google-maps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCbvck6I8YOPb1ajnafOkwrauA_st0kAnE&libraries=places', array(), null, true );
	    	wp_enqueue_script( 'wcfmd-route-optimizer', $this->js_lib_url . 'wcfmd-script-route-optimizer.js', array('jquery', 'wcfmd-google-maps'), $WCFMd->version, true );
  ...
  public function load_styles( $end_point ) {
	  ...
	  switch( $end_point ) {
		  ...
		  case 'wcfm-deliveries-pdf':
		  	wp_enqueue_style( 'wcfmd_deliveries_pdf_css', $this->css_lib_url . 'wcfmd-style-deliveries-pdf.css', array(), $WCFMd->version );
		  break;
	...
	public function load_views( $end_point ) {
      ...
      case 'wcfm-deliveries-pdf':
				$WCFMd->template->get_template( 'wcfmd-view-deliveries-pdf.php' );
      break;
    }
  }
