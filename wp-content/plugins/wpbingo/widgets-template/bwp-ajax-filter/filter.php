<?php
	...
	if(!isset($chosen_attributes)){
		...
		if(isset($_GET['rating_filter']) && $_GET['rating_filter']){
			$chosen_attributes['pa_rating']['terms'] = explode(',',$_GET['rating_filter']);
...
<div  class="bwp-filter-ajax">
	...
	//Filter Rating
	if($show_rating)
		$this->woocommerce_rating_filter($id_category,$tax_query,$meta_query,$chosen_attributes,$showcount);
	?>
	</form>
</div>
