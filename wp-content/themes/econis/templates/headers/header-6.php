				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-5 col-lg-4 col-md-12 col-sm-12 col-12 header-right">
							<?php if( isset($econis_settings['phone']) && $econis_settings['phone'] ) : ?>
							<div class="phone hidden-md hidden-sm hidden-xs">
								<i class="icon-headphone"></i>
								<div class="content">
									<h2><?php echo esc_html__("CALL US FREE ","econis") ?></h2>
									<a href="tel:<?php echo esc_html($econis_settings['phone']); ?>"><?php echo esc_html($econis_settings['phone']); ?></a>
								</div>
							</div>
							<?php endif; ?>
